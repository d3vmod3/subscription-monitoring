...
<div class="p-4 max-w-full overflow-x-hidden">
    ...
    <div class="flex flex-col sm:flex-row justify-between mb-4 gap-3">
        ...
        <div class="flex-shrink-0">
            <flux:modal.trigger name="add-advance-payment">
                <flux:button>Add Advance Payment</flux:button>
            </flux:modal.trigger>
            <flux:modal name="add-advance-payment" class="w-full">
        ...
        <table class="min-w-full border border-gray-200">
            <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                    ...
                    @can('edit advance payments')
                    <th class="px-4 py-2 border whitespace-nowrap text-center">Action</th>
                    @endcan
                </tr>
            </thead>

            <tbody>
                @forelse ($advance_payments as $payment)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-white transition-colors duration-150">
                        ...
                        <td class="px-4 py-2 border whitespace-nowrap text-center">
                            <flux:link href="{{ route('advance-payment.edit', ['hash' => $hashids->encode($payment->id)]) }}" >
                                Edit
                            </flux:link>
                        </td>
                        @endcan
