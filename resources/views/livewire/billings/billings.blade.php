    ...
    @if($subscriptionHash)
        <div class="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
            ...
            <div class="sm:col-span-3 mt-2">
                <flux:button wire:click="filterPayments" class="w-full sm:w-auto">Calculate Bills</flux:button>
            </div>
        </div>
        ...
        <div class="mt-4 p-4 border rounded bg-white dark:bg-zinc-700 text-zinc-900 dark:text-zinc-100 space-y-1">
            ...
            <div class="flex justify-between">
                ...
                <span class="text-blue-600 font-bold">₱{{ $totalRemaining }}</span>
            </div>
            <div class="flex justify-between">
        ...
        @if ($payments && $payments->count())
            ...
            <div class="overflow-x-auto mt-2">
                <table class="w-full border text-zinc-900 dark:text-zinc-100 min-w-[600px]">
                    <thead>
