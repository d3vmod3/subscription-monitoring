<div class="max-w-3xl mx-auto p-6 bg-white dark:bg-zinc-700 rounded-lg shadow space-y-6 dark:shadow-lg">
    ...
    <h2 class="text-2xl font-bold mb-6 text-zinc-900 dark:text-zinc-100">Edit Payment Method</h2>
    {{-- Name --}}
    <div>
    ...
    <div class="flex justify-end space-x-2 mt-4">
        ...
        <flux:link href="{{ route('payment-methods') }}" variant="secondary" class="border flex justify-center rounded-xl p-2 hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-white transition-colors duration-150" style="text-decoration: none;">Payment Methods List</flux:link>
    </div>
</div>
