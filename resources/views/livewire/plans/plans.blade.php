...
<div class="p-4">
    <div class="flex justify-between mb-4">
        <input type="text" wire:model.live="search" placeholder="Search plans..." class="border rounded px-3 py-2 w-1/3">
        <div>
    ...
    <table class="w-full border border-gray-200">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" class="px-4 py-2 text-center text-gray-500">No plans found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
