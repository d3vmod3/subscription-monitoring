<div class="max-w-3xl mx-auto p-6 bg-white dark:bg-zinc-700 rounded-lg shadow dark:shadow-lg">
    ...
    <h2 class="text-2xl font-bold mb-6 text-zinc-900 dark:text-zinc-100">Add Sector</h2>
    ...
    <form wire:submit.prevent="save" class="space-y-4">
        ...
        <div class="flex flex-col md:flex-row justify-between mt-4 gap-4">
            <flux:link 
                class="border flex justify-center rounded-xl p-2 hover:bg-zinc-50 dark:hover:bg-zinc-700 dark:hover:text-white transition-colors duration-150"
                href="{{ route('sectors') }}" 
